\chapter{Higher-order countediabatic driving as a cost function}

In the previous chapter I presented the idea of combining approxmate (local) counterdiabatic driving (\acrref{LCD}) and quantum optimal control in order to improve 
