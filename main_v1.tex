...
\input{chapters_v1/declaration.tex}
\input{chapters_v1/abstract.tex}

\tableofcontents

\input{chapters_v1/lay_summary}
\input{chapters_v1/acknowledgements}

\input{chapters_v1/abbreviations}
...
\input{chapters_v1/introduction}
\input{chapters_v1/background_adiabaticity}
\input{chapters_v1/background_optimal_control}
\input{chapters_v1/COLD}
\input{chapters_v1/minimising_higher_order_lcd}
\input{chapters_v1/applications_fidelity}
\input{chapters_v1/applications_higher_order}
\input{chapters_v1/conclusion}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{chapters_v1/appendix}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
